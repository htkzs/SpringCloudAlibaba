package com.itheima.gateway.configuration;
...
//基于gateway的分组API的限流
@Configuration
public class GatewayGroupConfiguration {
    private final List<ViewResolver> viewResolvers;
    private final ServerCodecConfigurer serverCodecConfigurer;

    public GatewayGroupConfiguration(ObjectProvider<List<ViewResolver>> viewResolversProvider, ServerCodecConfigurer serverCodecConfigurer) {
